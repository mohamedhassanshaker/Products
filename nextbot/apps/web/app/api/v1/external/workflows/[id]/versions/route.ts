...
/** `GET /api/v1/external/workflows/{id}/versions` (RBAC: agent_platform=Read). */
...
/** `POST /api/v1/external/workflows/{id}/versions` (RBAC: agent_platform=Write) —
 * every V1-V12 authoring-schema/node-validation rule from LLD §14.6.3 applies
 * identically to a version minted through this route. */
