...
(function () {
  ...
  var PORTALS = [
    { k: "A", name: "A — Embeddable AI Assistant Widget", users: "End customer / Employee" },
    { k: "B", name: "B — Admin Console", users: "Platform Admin, Backend System Owner" },
    { k: "CFG", name: "Configuration", users: "Platform Admin, Platform Engineer" },
    { k: "C", name: "C — Conversation Designer Studio", users: "Conversation / Bot Designer" },
    { k: "D", name: "D — Human Agent Bridge", users: "Human Escalation Agent" },
    { k: "E", name: "E — Developer Portal", users: "Developer / Integrator" }
  ];
